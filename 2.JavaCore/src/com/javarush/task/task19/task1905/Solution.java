    ...
    public static class DataAdapter implements RowItem {
        ...
        public String getCountryCode() {
            ...
            for (Map.Entry<String, String> pair: countries.entrySet()){
                String codeCountry = pair.getKey();
                String nameCountry = pair.getValue();
                if (nameCountry.equals(country)){
                    return codeCountry;
                }
            }
            return null;
        ...
        public String getDialString() { //For example: callto://+380501234567
            ...
            String call = contact.getPhoneNumber();
            String callFull = call.replaceAll("[\\D]", "");
            return "callto://+" + callFull;
        }
    }
